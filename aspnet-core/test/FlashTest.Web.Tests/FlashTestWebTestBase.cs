...
{
    public abstract class FlashTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FlashTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FlashTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FlashTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FlashTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FlashTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FlashTestDbContext, Task<T>> func)
        {
            T result;
