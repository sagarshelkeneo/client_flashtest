...
@Injectable()
export class NumberCheckServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateNumberCheckDto | undefined): Observable<NumberCheckDto> {
        let url_ = this.baseUrl + "/api/services/app/DisplayNumberHistoryService/CreateDisplayNumberHistory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<NumberCheckDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<NumberCheckDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<NumberCheckDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = NumberCheckDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<NumberCheckDto>(<any>null);
    }
...
export class CreateNumberCheckDto implements ICreateNumberCheckDto {
    InputNumber: string | undefined;
    OutputResult: string | undefined;
    //UserId: number | undefined;
    //IsActive: boolean | undefined;

    constructor(data?: ICreateNumberCheckDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.InputNumber = data["InputNumber"];
    ...
    static fromJS(data: any): CreateNumberCheckDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateNumberCheckDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["entryNumber"] = this.InputNumber;
        data["outputNumber"] = this.OutputResult;
        //data["errorMessage"] = this.errorMessage;
        //data["result"] = this.result;
        return data;
    }

    clone(): CreateNumberCheckDto {
        const json = this.toJSON();
        let result = new CreateNumberCheckDto();
        result.init(json);
        return result;
...
export interface ICreateNumberCheckDto {
    InputNumber: string | undefined;
    OutputResult: string | undefined;
    //UserId: number | undefined;
    //IsActive: boolean | undefined;
...
export class NumberCheckDto implements INumberCheckDto {
    InputNumber: string | undefined;
    OutputResult: string | undefined;
    //UserId: number | undefined;
    //IsActive: boolean | undefined;
    ...
    constructor(data?: INumberCheckDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): NumberCheckDto {
        data = typeof data === 'object' ? data : {};
        let result = new NumberCheckDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["InputNumber"] = this.InputNumber;
        data["OutputResult"] = this.OutputResult;        
        data["id"] = this.id;
        return data;
    }

    clone(): NumberCheckDto {
        const json = this.toJSON();
        let result = new NumberCheckDto();
        result.init(json);
        return result;
...
export interface INumberCheckDto {
    InputNumber: string | undefined;
    OutputResult: string | undefined;
    //UserId: number | undefined;
    //IsActive: boolean | undefined;
